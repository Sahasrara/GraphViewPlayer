...
//     }
//
//     public class PortManipulator<TEdge> : PortManipulator where TEdge : BaseEdge, new()
//     {
...
//
//             if (CanPerformConnection(e.localMousePosition)) { m_EdgeDragHelper.HandleDragEnd(e); }
//             else { m_EdgeDragHelper.HandleDragCancel(); }
//
//             m_Active = false;
//             target.ReleaseMouse();
//             e.StopPropagation();
...
//         {
//             if (e.keyCode != KeyCode.Escape || !m_Active) { return; }
//
//             DitchFocus();
...
//             Vector2.Distance(m_MouseDownPosition, mousePosition) > k_ConnectionDistanceTreshold;
//
